...
#' @importFrom psych tr
#'
#' @examples Estimation(1,5,0.05,2,4,4,20,0,0,1,1,0.3,0.3,0.5,0.5,2.5,0,1,1,1,
#' 1,3,2)
Estimation=function(ITER,MHiteration,eps,d,nSample,mm,time,MuxStar0,MuxInd0,SigmaxStar0,SigmaxInd0,Sigmav0,Sigmaw0,lambda0,sigma0,delta0,alpha0,beta10,beta20,beta30,beta40,InfPeriod,g){
